...
%----------------------------------------------------------------------------------------
 ...
 % {\small(available on \href{https://github.com/johngeorgesample}{github.com/johngeorgesample})}
   ...
   \item Available at \href{https://pgh.coffee/}{\color{blue}{\underline{pgh.coffee}}} \textbar \ \href{https://github.com/Johngeorgesample/pgh-coffee}{\color{blue}{\underline{source code}}}
   \end{rSubsection}
