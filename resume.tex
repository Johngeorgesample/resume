...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}[img/grafana-logo.png]{Grafana Labs}{React, TypeScript}{Senior Front-end Engineer}{Apr. 2025 – Present}
    \item Working on the Adaptive Telemetry team
  \end{rSubsection}
  
  \begin{rSubsection}[img/niche.png]{Niche.com}{React, Redux, TypeScript, Less}{Senior Front-end Engineer}{Sept. 2021 – Mar. 2025}
  ...
  \begin{rSubsection}[img/promantus-logo.png]{Promantus Inc.}{Vue.js, Vuex, Nuxt, JavaScript, Sass, Tailwind CSS}{Front-end Engineer}{Nov. 2019 – Sept. 2021}
