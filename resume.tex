...
\item Pioneered the company’s first LLM-powered feature by exploring OpenAI’s API, LLM hosting, and token optimization. Developed a system that converts data tables into natural-language summaries, later presented to the board to showcase the potential of generative AI
...
% \item Led the development of a new registration flow utilizing SOMETHING. Resulted in a streamlined user experience and increased monthly registrations by 13\%
...
\item Promoted knowledge sharing by delivering technical talks on topics like Tailwind CSS, semantic HTML, and tmux (recordings available at \href{http://jgs.lol/}{\color{blue}{\underline{jgs.lol}}})
